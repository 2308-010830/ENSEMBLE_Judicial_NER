...
def train(embedding_name, dataset_type='conll2003', lang='en', architecture='BidLSTM_CRF', use_ELMo=False, use_BERT=False, data_path=None):
    ...
    #    model = sequenceLabelling.Sequence('ner-en-ontonotes', max_epoch=11, embeddings_name=embedding_name)
    #elif (lang == 'fr'):
    #    model = sequenceLabelling.Sequence('ner-fr-lemonde', max_epoch=11, embeddings_name=embedding_name)
